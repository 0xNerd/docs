...
The staking system allows users to stake OIL tokens and earn **SOL rewards** from protocol revenue. Stakers earn 2% of all round winnings, distributed proportionally based on their stake score.
...
* **Claim**: Claim accumulated SOL rewards.

#### Reward Source

**SOL Rewards:**

* Come from 2% of round winnings (protocol revenue)
* Distributed proportionally based on stake score
* Claimed as native SOL
