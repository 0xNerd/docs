...
OIL is a Fogo-native store of value protocol built around **continuous Dutch auction-based mining**. Bid FOGO to operate one of four OIL wells and earn tokens in real-time.
